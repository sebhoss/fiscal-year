...
public class FiscalDateGetCalendarDayOfMonthTest {
    ...
    /**
     * Ensures that for any given date the correct calendar day of month will be returned.
     * 
     * @param startDate
     ...
     */
    @Theory
    public void shouldReturnCalendarDayOfMonth(final Months startDate, final Comparator<Months> monthComparator,
