...
public class FiscalDateGetCalendarYearTest {
    ...
    /**
     * Ensures that for any given date the correct calendar year will be returned.
     * 
     * @param startDate
     ...
     */
    @Theory
    public void shouldReturnCalendarYear(final Months startDate, final Comparator<Months> monthComparator,
